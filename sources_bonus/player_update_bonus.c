...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/04 23:41:48 by pedroadias        #+#    #+#             */
/*   Updated: 2021/10/04 23:49:32 by pedroadias       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	player_update_image(char key, t_game *game)
{
	...
	if (key == 'w')
		game->img_player = mlx_xpm_file_to_image
			(game->mlx, "assets/images/P_W.xpm", &game->img_w, &game->img_h);
	else if (key == 's')
		game->img_player = mlx_xpm_file_to_image
			(game->mlx, "assets/images/P_S.xpm", &game->img_w, &game->img_h);
	else if (key == 'd')
		game->img_player = mlx_xpm_file_to_image
			(game->mlx, "assets/images/P_D.xpm", &game->img_w, &game->img_h);
	else if (key == 'a')
		game->img_player = mlx_xpm_file_to_image
			(game->mlx, "assets/images/P_A.xpm", &game->img_w, &game->img_h);
}
